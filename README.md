...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy? template=https://github.com/Cybreporali/File-Sharing-Bot)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.CodeXBotz/File-Sharing-Bot
cd File-Sharing-Bot
